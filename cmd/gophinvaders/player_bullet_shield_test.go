...
func TestPlayerBulletShieldCollision(t *testing.T) {
	...
	// Create an active player bullet that will collide with the shield.
	game.PlayerBullets[0] = PlayerBullet{
		Active: true,
		LeftX:  120,
		TopY:   110,
	}

	game.HandlePlayerBulletShieldCollisions()
...
func TestPlayerBulletShieldDestroyed(t *testing.T) {
	game := NewGame(nil, nil)
...
func TestPlayerBulletShieldNotDestroyed(t *testing.T) {
	game := NewGame(nil, nil)
...
func TestPlayerBulletHitsOnlyOneShield(t *testing.T) {
	game := NewGame(nil, nil)
	...
	// Create an active player bullet that will collide with both.
	game.PlayerBullets[0] = PlayerBullet{
		Active: true,
		LeftX:  120,
		TopY:   120,
...
func TestMultiplePlayerBulletsHitSameShield(t *testing.T) {
	game := NewGame(nil, nil)
	...
	// Create two active player bullets that will both collide with the shield.
	game.PlayerBullets[0] = PlayerBullet{
		Active: true,
		LeftX:  120,
		TopY:   110,
	}
	game.PlayerBullets[1] = PlayerBullet{
		Active: true,
		LeftX:  125,
		TopY:   115,
	}
...
func TestDestroyedShieldNoLongerCollidesWithPlayerBullet(t *testing.T) {
	game := NewGame(nil, nil)
	...
	// Create an active player bullet that will destroy shield1.
	game.PlayerBullets[0] = PlayerBullet{
		Active: true,
		LeftX:  120,
		TopY:   110,
